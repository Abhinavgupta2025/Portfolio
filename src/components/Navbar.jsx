      ...
      <div className="container mx-auto px-6 md:px-12 flex justify-between items-center max-w-7xl">
        ...
        >
          <a href="#home" className="group flex items-center gap-3">
             ...
             <span className="text-white text-[11px] font-bold uppercase tracking-widest hidden sm:block opacity-0 group-hover:opacity-100 transition-opacity duration-500">Abhinav</span>
          </a>
        </motion.div>
        ...
        <div className="hidden md:block">
           <a 
            href="/resume.pdf" 
            download="Abhinav_Gupta_Resume.pdf"
