...
const Achievements = () => {
  ...
  const achievements = [
    ...
    },
    {
      ...
      title: "Top 20% Coder",
      platform: "Leetcode",
      desc: "Achieved elite rating on CodeChef platform demonstrating advanced problem-solving abilities."
    },
    {
      icon: <FaChartLine size={20} />,
      title: "Full Stack Development",
      platform: "Multiple Projects",
      desc: "Built and deployed multiple full-stack applications using React, Node.js, and MongoDB."
    },
    {
      icon: <FaTrophy size={20} />,
      title: "System Design",
      platform: "LLD",
      desc: "Proficient in designing scalable system architectures and solving complex technical challenges."
    }
  ];
