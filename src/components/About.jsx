      ...
      >
        <motion.div variants={itemVariants} className="mb-16">
          ...
          <p className="text-[#a1a1aa] text-lg leading-relaxed max-w-3xl">
            I am a Full Stack Developer specializing in React, Node.js, and MongoDB. With a strong foundation in DSA and competitive programming, I build high-performance web applications that combine technical excellence with user-centric design.
          </p>
        </motion.div>
